...
/**
 * This is the model class for table "sales_shipping_aggregated_order".
 *
 * The followings are the available columns in table 'sales_shipping_aggregated_order':
 * @property string $id
 ...
 */
class Mage1SalesShippingAggregatedOrderPeer extends Mage1ActiveRecord
{
	/**
	 ...
	 * @return Mage1SalesShippingAggregatedOrderPeer the static model class
	 */
