...
/**
 * This is the model class for table "sales_order_aggregated_created".
 *
 * The followings are the available columns in table 'sales_order_aggregated_created':
 * @property string $id
 ...
 */
class Mage1SalesOrderAggregatedCreatedPeer extends Mage1ActiveRecord
{
	/**
	 ...
	 * @return Mage1SalesOrderAggregatedCreatedPeer the static model class
	 */
