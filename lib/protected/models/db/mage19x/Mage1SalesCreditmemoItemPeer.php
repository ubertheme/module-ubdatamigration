...
/**
 * This is the model class for table "sales_flat_creditmemo_item".
 *
 * The followings are the available columns in table 'sales_flat_creditmemo_item':
 ...
 */
class Mage1SalesCreditmemoItemPeer extends Mage1ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('base_price, tax_amount, base_row_total, discount_amount, row_total, base_discount_amount, price_incl_tax, base_tax_amount, base_price_incl_tax, qty, base_cost, price, base_row_total_incl_tax, row_total_incl_tax, hidden_tax_amount, base_hidden_tax_amount, weee_tax_disposition, weee_tax_row_disposition, base_weee_tax_disposition, base_weee_tax_row_disposition, base_weee_tax_applied_amount, base_weee_tax_applied_row_amnt, weee_tax_applied_amount, weee_tax_applied_row_amount', 'length', 'max'=>12),
	 ...
	 * @return Mage1SalesCreditmemoItemPeer the static model class
	 */
