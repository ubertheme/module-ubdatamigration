 ...
 */
class Mage2CatalogProductEntityGalleryPeer extends Mage2ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('attribute_id, store_id, position', 'numerical', 'integerOnly'=>true),
	 ...
	 * @return Mage2CatalogProductEntityGalleryPeer the static model class
	 */
