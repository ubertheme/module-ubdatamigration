 ...
 *
 * The followings are the available columns in table 'sales_order_address':
 ...
 */
class Mage2SalesOrderAddressPeer extends Mage2ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('customer_address_id, quote_address_id, region_id, customer_id, vat_is_valid, vat_request_success', 'numerical', 'integerOnly'=>true),
	 ...
	 * @return Mage2SalesOrderAddressPeer the static model class
	 */
