...
/**
 * This is the model class for table "sales_creditmemo_item".
 *
 * The followings are the available columns in table 'sales_creditmemo_item':
 ...
 */
class Mage2SalesCreditmemoItemPeer extends Mage2ActiveRecord
{
	/**
	 ...
	 * @return Mage2SalesCreditmemoItemPeer the static model class
	 */
