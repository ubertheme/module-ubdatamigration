 ...
 */
class Mage2SalesrulePeer extends Mage2ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('uses_per_customer, is_active, stop_rules_processing, is_advanced, apply_to_shipping, is_rss, coupon_type, use_auto_generation, uses_per_coupon, simple_free_shipping', 'numerical', 'integerOnly'=>true),
	 ...
	 * @return Mage2SalesrulePeer the static model class
	 */
