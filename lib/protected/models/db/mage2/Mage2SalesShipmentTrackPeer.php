...
/**
 * This is the model class for table "sales_shipment_track".
 *
 * The followings are the available columns in table 'sales_shipment_track':
 ...
 */
class Mage2SalesShipmentTrackPeer extends Mage2ActiveRecord
{
	/**
	 ...
	 * @return Mage2SalesShipmentTrackPeer the static model class
	 */
