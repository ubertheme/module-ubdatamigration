 ...
 */
class Mage2SalesruleCouponPeer extends Mage2ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('expiration_date, created_at', 'safe'),
		);
	}
	 ...
	 * @return Mage2SalesruleCouponPeer the static model class
	 */
